...
// Exported so pairing.js can call it too, until contacts.js (a later
// consolidation cycle) becomes api()'s permanent home -- see pairing.js's
// own header comment for why this circular import is safe.
export { api };
